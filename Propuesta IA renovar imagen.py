### PROPUESTA DE IA PARA RENOVAR IMAGEN
...
def display_updated_image():
    st.image('marea.png', caption='Updated Mareas Image')

# Button to refresh the image
if st.button('Refresh Mareas Image'):
    display_updated_image()

# Automatically refresh the image every 60 seconds
while True:
    display_updated_image()
    time.sleep(60)