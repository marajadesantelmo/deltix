...
if __name__ == '__main__':
    ...
    message_handlers = [
        ...
        wrap_handler_with_tracking(MessageHandler(filters.Regex(r'(?i)(.*\bagenda\b.*)'), agenda_rio)),
        wrap_handler_with_tracking(MessageHandler(filters.Regex(r'(?i)(.*\bactividades\b.*)'), agenda_rio)),
        wrap_handler_with_tracking(MessageHandler(filters.Regex(r'(?i)(.*\bemprendimientos\b.*)'), agenda_rio)),
