...
def generate_main_menu():
    return ("- <b>/mareas </b>   <i> obtener el pronóstico de mareas &#9875</i>\n"
            ...
            "- <b>/notiDeltix </b>   <i> suscribirte al envío de info de interés</i>\n"
...
async def answer_colaborar(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    if user_response == 'aportar':
        ...
        await update.message.reply_text("<a href='https://cafecito.app/deltix' rel='noopener' target='_blank'> alt='Tambien podes aportar por la página cafecito.app' </a>", 
                                        parse_mode='HTML')
        return ConversationHandler.END    
