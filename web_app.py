...
KEYWORDS = {
    ...
    "nivelrio":    ['va a subir', 'va a bajar', 'empezar a subir', 'empieza a subir',
                    ...
                    'como va a estar el agua', 'cómo va a estar el agua',
                    'como esta el agua', 'cómo está el agua', 'como estara el agua',
                    'cómo estará el agua', 'va a estar el agua'],
    ...
    "taxifletes":         ['taxifletes', 'taxi fletes', 'lancha taxi', 'traslado isla', 'flete isla',
                           'flete', 'fletes', 'lancha flete', 'transporte en lancha', 'necesito un flete',
                           'taxi', 'necesito un taxi', 'quiero un taxi'],
    "deltafix":           ['deltafix', 'reparacion de celular', 'reparación de celular', 'reparacion celular',
                           ...
                           'reparar mi celular', 'reparar el celular', 'reparar celular',
                           'reparar mi telefono', 'reparar mi teléfono', 'reparar el telefono',
                           'reparar el teléfono', 'telefono roto', 'teléfono roto',
                           'reparacion de telefono', 'reparación de teléfono', 'arreglar el celular',
                           'arreglar mi celular', 'arreglar el telefono', 'arreglar mi telefono'],
